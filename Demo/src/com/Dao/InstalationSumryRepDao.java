...
public class InstalationSumryRepDao {
	...
	public List<InstalationBean> viewData(String role, String roleBelogs, String year,String mnthId) {
		String wherClause = "";
		if (role.equals("1")) {
		...
		try {
			String query = "SELECT "
							...
							+ " WHERE th.TH_YEAR = " + year + " AND th.TH_MONTH= "+mnthId+" " + wherClause
		...
		if (role.equals("1")) {
			dispInstalationBeans= zoneWise("first","0");
		} else if (role.equals("2")) {
			dispInstalationBeans= circleWise("first","0");
		} else if (role.equals("3")) {
			dispInstalationBeans= divWise("first","0");
		} else if (role.equals("4")) {
			dispInstalationBeans= subDivWise("first","0");
		} else if (role.equals("5")) {
			dispInstalationBeans= secWise("first","0");
		}
	...
	public List<InstalationBean> secWise(String id,String lvl) {
		...
		List<InstalationBean> tempRepBean = new ArrayList<InstalationBean>();
		dispInstalationBeans = new ArrayList<InstalationBean>();
		
		
		if(id.equals("first")){
			tempRepBean = instalationBeans;
		}else if(lvl.equals("4")){
			for (InstalationBean bean : instalationBeans) {
				if(bean.getSubDivId().equals(id)){
					tempRepBean.add(bean);
				}
			}
		}else if(lvl.equals("5")){
				for (InstalationBean bean : instalationBeans) {
					if(bean.getSecId().equals(id)){
						tempRepBean.add(bean);
					}
				}
		}
		...
		for (InstalationBean instalationBean : tempRepBean) {
			if (secId == 0) {
	...
	public List<InstalationBean> subDivWise(String id,String lvl) {
		int subDivId = 0;
		dispInstalationBeans = null;
		dispInstalationBeans = new ArrayList<InstalationBean>();
		InstalationBean instlBean = null;
	...
	public List<InstalationBean> divWise(String id,String lvl) {
		int divId = 0;
		dispInstalationBeans = null;
		dispInstalationBeans = new ArrayList<InstalationBean>();
		InstalationBean instlBean = null;
	...
	public List<InstalationBean> circleWise(String id,String lvl) {
		int crlId = 0;
	...
	public List<InstalationBean> zoneWise(String id,String lvl) {
		int znId = 0;
		List<InstalationBean> tempRepBean = new ArrayList<InstalationBean>();
		dispInstalationBeans = new ArrayList<InstalationBean>();
